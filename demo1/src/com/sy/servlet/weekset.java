...
public class weekset extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String sql="SELECT Week FROM tot_plan_ad WHERE Vehicle='"+value1+"' GROUP BY `Week` ; ";
		if(value1.equals("all")){
			sql="SELECT Week FROM tot_plan_ad  GROUP BY `Week` ; ";
		}
